...
(function defineMustache(global, factory) {
    ...
    function primitiveHasOwnProperty(primitive, propName) {
        return (
            primitive != null && typeof primitive !== 'object' && primitive.hasOwnProperty && primitive.hasOwnProperty(propName));
    }
            ...
            while (context) {
                if (name.indexOf('.') > 0) {
                    ...
                    while (intermediateValue != null && index < names.length) {
                        if (index === names.length - 1) lookupHit = (
    ...
    mustache.to_html = function to_html(template, view, partials, send) { /*eslint-enable*/
