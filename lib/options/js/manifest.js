...
var OPTIONS = {
	FORMS : {
		"options" : [
			...
			{"name":"contextURL", "id":"contextURL", "label":"Context URL", "value": "https://dqm.crownpeak.com/", "type" : "text", parent:'basicSettings'},
			{"name":"apikey", "id":"apikey", "label":"API Key", "value": "", "type" : "text", parent:'basicSettings'},
			{"name":"domain-key-value-pair", "id":"domain-key-value-pair", "label":"Domains - Website IDs", "type" : "key-value", tag:"div", parent:'basicSettings', data : [{cols:[{"title":"Domain name",initValue:"www.my-domain.com"},{"title":"Crownpeak website ID",initValue:""}]}]},
			...
			{"name":"cacheReports", "label":"Cache reports locally", "type":"checkbox", "value":"true", parent:'basicSettings'},
			{"name":"ClearCacheReports", "label": "", "type":"button", "value":"Clear cached reports", parent:'basicSettings', data:[{"display-only":""},{"custom-event":"clear-cache"}]},
		]
	},
