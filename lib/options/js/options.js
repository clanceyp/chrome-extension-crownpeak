/**
 * @author patcla https://github.com/clanceyp/chrome-extension-settings-form
 */
    ...
    optionsForm = {
        ...
        setupHelp:function(){
            for (var item in HELP){
                ...
                optionsForm.log("Help: "+ item + " not found");
            }
        },
        ...
        saveItemValue:function(target){
            optionsForm.log("saveItemValue", target);
            ...
            optionsForm.log("id", id, "name", name, "value", value, "type", type);
            if (type === "checkbox"){
            ...
            basic: function(element){
                ...
                $.each(element.attr, function(i, option){
                    for (var key in option){
                        if (option.hasOwnProperty(key)) {
                            optionsForm.log(key, option[key]);
                ...
                optionsForm.log(element.id, element.name, value, element.type, element.html5 );
                if (value !== null){
                    try {
...
$(document).ready(function(){
    ...
    $(document).on('click', "[data-custom-event='clear-cache']", backgroundPage.cp.clear);
