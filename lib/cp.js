...
var cp = {
    ...
    getWebsiteId: function(tab) {
        ...
        // var match = _.findWhere(domains, {key: tabUrl.host}); // strict domain name match
        var match = _.find(domains, function(domain) { // loose path match
            return !!tabUrl.href.match(domain.key || "missing-config");
        });
