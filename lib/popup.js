...
var popupType = backgroundPage.options.getLocalStore("popupType", "normal");
...
var init = function(json) {
    ...
    $("body").removeClass("loading").addClass(`body--${popupType} body--${popupTheme} body--showSiteName${popupShowSiteName}`);
